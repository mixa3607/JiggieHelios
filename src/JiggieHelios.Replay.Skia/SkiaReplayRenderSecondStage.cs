...
public class SkiaReplayRenderSecondStage
{
    ...
    private readonly ILogger<SkiaReplayRenderSecondStage> _logger;
    private readonly SkiaReplayRenderSecondStageOptions _options;
    private readonly JiggieProtocolTranslator _jiggieProtocolTranslator;

    public string OutputFile => _options.OutFile;

    public SkiaReplayRenderSecondStage(ILogger<SkiaReplayRenderSecondStage> logger, SkiaReplayRenderSecondStageOptions options,
        JiggieProtocolTranslator jiggieProtocolTranslator, SkiaRender render)
    {
        _logger = logger;
        _options = options;
